...
console.log(id)
const indianMoviesContainerEl = document.querySelector(".expandedLikeIndianMovies_container");
...
const renderDetails = async () => {
    ...
    indianMoviesContainerEl.innerHTML = template
...
const renderCast = async () => {
    ...
    casts.forEach((c) => {
        ...
        <div class="cast_detail">
          ...
          `
        indianMoviesContainerEl.appendChild(castHead);
    })
}
//----------------------------------------------------------------------------------------------
...
const renderCrew = async () => {
    ...
    crews.forEach((c) => {
        ...
        indianMoviesContainerEl.appendChild(crewHead);
    })
}
...
const renderReviews = async () => {
    ...
    reviews.forEach((rev) => {
        ...
        reviewCon.innerHTML += `
          ...
          `
        indianMoviesContainerEl.appendChild(reviewHead);
    })
}
...
const renderMoviesYouLike = async function() {
   ...
   const mayLikeMovies = movies.results.slice(5,15);
   ...
   mayLikeMovies.forEach((movie) => {
    ...
    mayLikeCon.innerHTML = `
             <a href="./likeIndianMovies.html?id=${id}">   
