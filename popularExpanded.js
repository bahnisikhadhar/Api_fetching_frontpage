...
console.log(id)
const popularMoviesContainerEl = document.querySelector(".expandedPopularMovie_container");
...
const renderCast = async () => {
    ...
    casts.forEach((c) => {
        ...
        <div class="cast_detail">
          ...
          `
          popularMoviesContainerEl.appendChild(castHead)
    })
}
//----------------------------------------------------------------------------------------------
...
const renderCrew = async () => {
    ...
    crews.forEach((c) => {
        ...
        popularMoviesContainerEl.appendChild(crewHead);
    })
}
...
const renderReviews = async () => {
    ...
    reviews.forEach((rev) => {
        ...
        reviewCon.innerHTML += `
          ...
          popularMoviesContainerEl.appendChild(reviewHead);
    })
}
...
const renderMoviesYouLike = async function() {
   ...
   mayLikeMovies.forEach((movie) => {
    ...
    mayLikeCon.innerHTML = `
             <a href="./popularExpanded.html?id=${id}">   
