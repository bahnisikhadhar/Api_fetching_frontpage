...
console.log(id)
const latestMoviesContainerEl = document.querySelector(".expandedLatestMovie_container");
...
const renderDetails = async () => {
    ...
    latestMoviesContainerEl.innerHTML = template
...
const renderCast = async () => {
    ...
    casts.forEach((c) => {
        ...
        <div class="cast_detail">
          ...
          latestMoviesContainerEl.appendChild(castHead);
    })
}
//----------------------------------------------------------------------------------------------
...
const renderCrew = async () => {
    ...
    crews.forEach((c) => {
        ...
        <div class="crew_detail">
         ...
         `
        latestMoviesContainerEl.appendChild(crewHead);
    })
}
...
const renderReviews = async () => {
    ...
    reviews.forEach((rev) => {
        ...
        reviewCon.innerHTML += `
          ...
          latestMoviesContainerEl.appendChild(reviewHead);
    })
}
...
const renderMoviesYouLike = async function() {
   ...
   mayLikeMovies.forEach((movie) => {
    ...
    mayLikeCon.innerHTML = `
             <a href="./latestMovieExpanded.html?id=${id}">   
